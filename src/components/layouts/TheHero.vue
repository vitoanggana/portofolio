<template>
  <div class="flex flex-col gap-8">
    ...
    <p class="text-sm md:text-base leading-relaxed slg:text-lg lg:leading-loose">
      Oh yea, if you Yui/Aya or whoever is the cutest girl in surabaya/tasik.
      ごめんね、前にいったことについて本当に申し訳ございません。
      ...
      But I wont begging my knees just to get back to you. If you really still have interest in me, and not giving up. I know you would give me another chance.
